"""
Fixed predefined responses with proper character encoding
"""
...
def get_fixed_responses():
    ...
    return {
        ...
        "how to use filot": (
            ...
            "1. *Start with /start command* to initialize the bot\n"
            "2. *Use /info* to view top-performing pools and current market opportunities\n"
            "3. *Try /simulate [amount]* to see potential returns (e.g., /simulate 1000 for $1000)\n"
            "4. *Connect your wallet* with /wallet (address-based) or /walletconnect (QR code)\n"
            "5. *Set your risk profile* with the /profile command\n"
            "6. *Ask questions* about crypto investments, pools, or DeFi concepts anytime\n"
            "7. *Subscribe* to daily updates with /subscribe\n\n"
            "FiLot is designed to be your personal investment assistant, helping you navigate the complex world of DeFi with confidence and ease."
        ),
        ...
        "risk assessment": (
            ...
            "• Liquidity: Pool size and trading volume\n"
            "• Protocol security: Smart contract audits and history\n"
            "• Token fundamentals: Project backing and use cases\n"
            "• Market correlation: How tokens move in relation to broader markets\n"
            "This comprehensive analysis helps you make informed decisions based on your risk tolerance."
        ),

        "wallet integration": (
            "FiLot offers two ways to integrate your wallet:\n\n"
            "1. *Address-based integration* (/wallet command): Provide your Solana wallet address for basic tracking without "
            "needing to connect your actual wallet. This is read-only and doesn't require permissions.\n\n"
            "2. *WalletConnect integration* (/walletconnect command): Use the WalletConnect protocol for a secure, "
            "encrypted connection between FiLot and your wallet. This allows more detailed portfolio analysis but "
            "still doesn't give FiLot control over your funds."
        ),

        "risk profiles": (
            "FiLot tailors recommendations based on three risk profiles:\n\n"
            "• Conservative: Focus on stable pairs like USDC/USDT with lower returns but minimal volatility\n"
